...
const I18N = {
    en: {
        ...
        'sub.fmt.premiere':    '🎬 Premiere Package (ProRes+WAV+SRT+FCPXML)',
        ...
        'legal.premiere_package': '🎬 Legal Premiere Package',
    ...
    fr: {
        ...
        'sub.fmt.premiere':    '🎬 Package Premiere (ProRes+WAV+SRT+FCPXML)',
        ...
        'legal.premiere_package': '🎬 Package Premiere Légal',
...
function updateSubPreview() {
    ...
    // Derive font-style / font-weight from font name
    const fn = (fontFamily || '').toLowerCase();
    const isOblique = fn.includes('oblique') || fn.includes('italic');
...
function updateFormatInfo(val) {
    ...
    const map = {
        ...
        premiere_package:  [dict['sub.info.premiere']  || 'Full asset bundle for Adobe Premiere Pro.', 'var(--primary)'],
    };
